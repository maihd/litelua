...
set LITELUA_LUAU_FOLDER=%LITELUA_DIR%\libs\luau-0.660
...
set LITELUA_LUAU_OUTPUT=%LITELUA_OUTPUT%\litelua_luau_0.660
...
clang++ -c src\litelua_luau.cpp -o %LITELUA_BUILD_DIR%\litelua_luau.obj %LITELUA_LUAU_COMPILE_OPTIONS%
