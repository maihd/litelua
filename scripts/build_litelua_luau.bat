...
set LITELUA_LUAU_FOLDER=%LITELUA_DIR%\libs\luau
set LITELUA_LUAU_INCLUDE=%LITELUA_LUAU_FOLDER%\include
:: set LITELUA_LUAU_LIBRARY=%LITELUA_LUAU_FOLDER%\prebuilt\x64\Luau.Compiler.lib %LITELUA_LUAU_FOLDER%\prebuilt\x64\Luau.VM.lib
set LITELUA_LUAU_OUTPUT=%LITELUA_OUTPUT%\litelua_luau
...
if not exist "%LITELUA_LUAU_OUTPUT%\prebuilt\win_x64" (
    mkdir "%LITELUA_LUAU_OUTPUT%\prebuilt\win_x64"
)
...
xcopy "%LITELUA_BUILD_DIR%\litelua_luau.lib" "%LITELUA_LUAU_OUTPUT%\prebuilt\win_x64" /D /E /Y /Q
