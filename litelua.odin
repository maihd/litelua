...
when ODIN_OS == .Windows {
    foreign import lib "output/litelua_luajit/win_x64/litelua_luajit.lib"
} else when ODIN_OS == .Linux && ODIN_ARCH == .amd64 {
    foreign import lib "output/litelua_luajit/linux_x64/litelua_luajit.a"
} else when ODIN_OS == .Darwin && ODIN_ARCH == .arm64 {
    foreign import lib "output/litelua_luajit/mac_arm64/litelua_luajit.a"
}
...
LUAJIT_VERSION_MAJOR    :: "2"
LUAJIT_VERSION_MINOR    :: "1"
LUAJIT_VERSION_NUM      :: 201
LUAJIT_VERSION_RELEASE  :: "4"

VERSION         		:: "LiteLua " + VERSION_MAJOR + "." + VERSION_MINOR
RELEASE         		:: VERSION + "." + VERSION_RELEASE
COPYRIGHT       		:: RELEASE + "  Copyright (C) 2025-2026, MaiHD"
AUTHORS         		:: "MaiHD"
...
LUAJIT_VERSION          :: "Lua " + LUAJIT_VERSION_MAJOR + "." + LUAJIT_VERSION_MINOR
LUAJIT_RELEASE          :: LUAJIT_VERSION + "." + LUAJIT_VERSION_RELEASE
LUAJIT_COPYRIGHT        :: LUAJIT_RELEASE + "  Copyright (C) 2005-2026 Mike Pall"
LUAJIT_AUTHORS          :: "Mike Pall"


/* mark for precompiled code ('<esc>Lua') */
LUA_SIGNATURE :: "\x1bLua"
LUAJIT_SIGNATURE :: "\x1bLua"
